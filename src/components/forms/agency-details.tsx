    ...
    return (
        <AlertDialog>
            <Card className='border-none'>
                ...
                <CardContent>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleSubmit)} className='grid grid-cols-3 space-y-4 gap-2'>
                            <FormField
                                disabled={isLoading}
                            ...
                            <FormField
                                ...
                                render={({ field }) => {
                                return (
                                    <FormItem className="col-span-3 flex flex-row items-center justify-between rounded-lg border gap-4 p-4">
                                    <div>
                    ...
                    {data?.id && (
                        <div className="flex flex-row flex-wrap items-center justify-between rounded-lg border border-destructive gap-4 p-4 mt-4">
                            <div>
                                <div>Danger Zone</div>
                            </div>
