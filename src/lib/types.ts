...
import { _getTicketsWithAllRelations, getAuthUserDetails, getFunnel, getFunnels, getMedia, getPipelineDetails, getTicketsWithTags, getUserPermissions } from "./queries"
import { db } from "./db"
...
export type FunnelsForSubAccount = Prisma.PromiseReturnType<typeof getFunnel>[0]
