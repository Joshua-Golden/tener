...
export const saveActivityLogsNotification = async ({description, agencyId, subaccountId} : {description: string, agencyId?: string, subaccountId?: string}) => {
    ...
    if (!foundAgencyId) {
        if (!subaccountId) {
            throw new Error ("You need to provide an agencyId or subaccountId")
        }
