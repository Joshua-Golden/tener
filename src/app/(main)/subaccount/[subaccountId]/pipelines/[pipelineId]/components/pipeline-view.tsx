...
const PipelineView = ({ lanes, pipelineDetails, pipelineId, subaccountId, updateLanesOrder, updateTicketsOrder, }: PipelineViewProps) => {
    ...
    switch (type) {
      ...
      case 'ticket': {
        ...
        if (source.droppableId === destination.droppableId) {
          ...
          originLane.Tickets.forEach((ticket: Ticket, idx: number) => {
            ticket.order = idx
          })
          ...
          destinationLane.Tickets.forEach((ticket: Ticket, idx: number) => {
            ticket.order = idx
          })
          setAllLanes(newLanes)
          updateTicketsOrder([
