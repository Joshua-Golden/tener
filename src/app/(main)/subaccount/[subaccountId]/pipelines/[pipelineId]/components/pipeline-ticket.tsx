...
const PipelineTicket = ({ allTickets, index, setAllTickets, subaccountId, ticket }: PipelineTicketProps) => {
  ...
  const handleDeleteTicket = async () => {
    try {
      setAllTickets((tickets: any) => tickets.filter((t: any) => t.id !== ticket.id))
